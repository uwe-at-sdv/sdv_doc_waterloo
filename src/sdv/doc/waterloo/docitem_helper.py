...
OBJ_DOCSTRING_CACHE: Dict[int, str] = {}
...
def get_obj_docstring(obj: object) -> str:
	...
	"""
	oid = id(obj)
	if oid in OBJ_DOCSTRING_CACHE:
		return OBJ_DOCSTRING_CACHE[oid]
...
class DocSession:
	...
	def get_parsed(self, text: str) -> DocstringTree:
		return self._parsed_docstring_cache[text]

	def remember_parsed(self, text: str, tree: DocstringTree) -> None:
		self._parsed_docstring_cache[text] = tree
