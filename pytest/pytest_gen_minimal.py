#!/usr/bin/env python3
"""Pytests for waterlint subcommand gen-minimal."""
...
def test_gen_minimal_raw_to_file_validates(
	tmp_path: Path,
	obj: str,
	profile: str,
	indent: str,
) -> None:
	out_file = tmp_path / f"test_minimal_{obj.replace('.', '_')}_{indent}.py"
	res = run_waterlint(
		"gen-minimal",
		"--basedir",
		DIR_EXAMPLES,
...
def test_gen_minimal_raw_stdout_smoke() -> None:
	res = run_waterlint(
		"gen-minimal",
		"--basedir",
		DIR_EXAMPLES,
...
def test_gen_minimal_recursive_missing_only_filters_existing_docstrings() -> None:
	res = run_waterlint(
		"gen-minimal",
		"--basedir",
		DIR_EXAMPLES,
...
def test_gen_minimal_recursive_defaults_to_json() -> None:
	res = run_waterlint(
		"gen-minimal",
		"--basedir",
		DIR_EXAMPLES,
...
def test_gen_minimal_recursive_multi_obj_deduplicates_targets() -> None:
	res = run_waterlint(
		"gen-minimal",
		"--basedir",
		DIR_EXAMPLES,
...
def test_gen_minimal_format_raw_requires_exactly_one_target() -> None:
	res = run_waterlint(
		"gen-minimal",
		"--basedir",
		DIR_EXAMPLES,
